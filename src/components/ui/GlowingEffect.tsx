        ...
        const handleMove = useCallback(
            (e?: MouseEvent | { x: number; y: number }) => {
                ...
                animationFrameRef.current = requestAnimationFrame(() => {
                    ...
                    // Kill any existing angle animation
                    if (angleTweenRef.current) {
                        angleTweenRef.current.kill();
                    }

                    // Create new GSAP animation
                    angleTweenRef.current = gsap.to(element, {
                        '--start': newAngle,
            ...
            <>
                ...
                <div
                  ...
                  var(--black) calc(25% / var(--repeating-conic-gradient-times))
                                    ...
                                    : `radial-gradient(circle at center, #7023C3 0%, #7023C3 40%, #FFCEB0 100%)`,
